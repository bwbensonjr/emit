...
(define-library (scheme base)
  ...
  (begin
    ...
    (define (string->number s . rest) (let ((r (if (null? rest) 10 (car rest)))) (if (%radix-ok? r) (if (= r 10) (cond ((rd-numeric? s) (rd-parse-int s)) ((rd-flonum? s) (%string->flonum s)) (else #f)) (%string->int s r)) (error "string->number: unsupported radix" r))))
