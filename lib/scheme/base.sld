...
(define-library (scheme base)
  ...
  (begin
    ...
    (define (number->string n) (if (exact? n) (cond ((= n 0) "0") ((< n 0) (list->string (cons #\- (ns-digits n (quote ()))))) (else (list->string (ns-digits (- 0 n) (quote ()))))) (%flonum->string n)))
    ...
    (define (rd-atom s n i) (let ((j (rd-token-end s n i))) (let ((tok (substring s i j))) (cons (cond ((rd-numeric? tok) (rd-parse-int tok)) ((rd-flonum? tok) (%string->flonum tok)) (else (string->symbol tok))) j))))
