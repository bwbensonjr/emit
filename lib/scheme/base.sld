...
(define-library (scheme base)
  ...
  (begin
    ...
    (define (rd-hash s n i) (let ((k (char->integer (string-ref s i)))) (cond ((= k 116) (cons #t (+ i 1))) ((= k 102) (cons #f (+ i 1))) ((= k 92) (rd-char s n i)) ((= k 40) (let ((r (rd-list s n (+ i 1) (quote ())))) (cons (list->vector (car r)) (cdr r)))) (else (let ((j (rd-token-end s n i))) (cons (string->symbol (substring s i j)) j))))))
