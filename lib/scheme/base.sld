...
(define-library (scheme base)
  ...
  (begin
    (define-syntax case (syntax-rules (else =>) ((_ (key ...) clause ...) (let ((k (key ...))) (case k clause ...))) ((_ k) (if #f #f)) ((_ k (else => f)) (f k)) ((_ k (else e ...)) (begin e ...)) ((_ k ((d ...) => f) clause ...) (if (memv k (quote (d ...))) (f k) (case k clause ...))) ((_ k ((d ...) e ...) clause ...) (if (memv k (quote (d ...))) (begin e ...) (case k clause ...)))))
    ...
    (define (list? x) (let loop ((slow x) (fast x)) (cond ((null? fast) #t) ((not (pair? fast)) #f) (else (let ((fast1 (cdr fast))) (cond ((null? fast1) #t) ((not (pair? fast1)) #f) (else (let ((slow1 (cdr slow)) (fast2 (cdr fast1))) (if (eq? slow1 fast2) #f (loop slow1 fast2))))))))))
    (define (zero? n) (= n 0))
